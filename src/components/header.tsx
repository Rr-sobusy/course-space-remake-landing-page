...
export const Page = (props: Props) => {
  ...
  return (
    <>
      {" "}
      <header className="flex justify-between font-Poppins items-center max-w-[1200px] mx-auto h-[84px] bg-bcolor px-[24px]">
        ...
        >
          ...
          <div className="absolute flex items-center justify-center w-full h-16 gap-2 bottom-6">
            <button className="px-3 py-2 border-2 rounded-lg border-primary text-primary">Sign In</button>
            <button className="px-3 py-2 text-white rounded-lg bg-primary">Sign Up</button>
          </div>
